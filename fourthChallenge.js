...
It's not allowed to use an if/else statement � (If it's easier for you, you can start with an if/else statement, and 
...
console.log(`The bill was ${bill}, the tip was ${tipCalculator(bill)}, and the total value ${bill + tipCalculator(bill)}`);
