...
const pollObject = {
	...
	question: "What is your favourite programming language?",
 	...
 	registerNewAnswer: function(favouriteProgrammingLanguageNumber){
 		typeof favouriteProgrammingLanguageNumber === 'number' && answer < this.answer.length && 			  			this.answers[favouriteProgrammingLanguageNumber]++;
 		this.displayResults(); 	    	
 	},
