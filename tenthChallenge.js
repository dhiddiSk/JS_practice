...
const game = {
 ...
 console.log(`The names of the teams are (${team1}) and (${team2})`);
 ...
 const teamWins = function(){
 	(game.odds.team1 < game.odds.team2) && console.log(`team1 is more likely to win than team2`);
 }
 teamWins();
